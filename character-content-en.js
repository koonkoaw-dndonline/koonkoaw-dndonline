...
(function attachCharacterEnglish(root){
  ...
  const races={
    human:[f('Skillful (Human)','Variant Humans gain proficiency in 1 additional skill of their choice during character creation.'),f('Feat (Variant Human)','Gain 1 feat during character creation. Choose any supported feat on the SPECIAL TRAITS · FEATS card.')],
