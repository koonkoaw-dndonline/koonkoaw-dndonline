...
(function attachTtrpgI18n(root){
  ...
  root.TTRPG_I18N=Object.freeze({build:'20260720e3',catalogs:Object.freeze(catalogs),text,errorText,language,latinPublicTextVerdict,catalogRowVisibleForWorld,localizeCatalogRow,displayTextVerdict,safeEnglishSystemText,stripLanguageRepairMetaText,auditEnglishDom,installDisplayWall,uninstallDisplayWall,installDialogWall,translateDom});
})(globalThis);
